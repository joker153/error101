...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'https://t.me/+oZ3UyF6vNFAwZjk1')
                        ]
                    ]
                )
            )
     ...
     [
        ...
        buttons = [[
        InlineKeyboardButton('🍿Live Movies', url='https://cineflixhome.xyz'),
        InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/m5movietelegram'),
        InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.delete()
...
async def auto_filter(client, msg: pyrogram.types.Message, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>Hai 👋 {mention.message.from_user}</b> 😍\n\n<b>📁 Found ✨  Files For Your Query : {search} 👇</b> "
